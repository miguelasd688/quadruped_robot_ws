...
float anglesServo[12];
float oAnglesServo[12];
...
{  
  ...
  anglesIKFL.tetta = angles_msg->data.data[0];
  anglesIKFL.alpha = angles_msg->data.data[1];
  anglesIKFL.gamma = angles_msg->data.data[2];
  anglesIKBR.tetta = angles_msg->data.data[0];
  anglesIKBR.alpha = angles_msg->data.data[1];
  anglesIKBR.gamma = angles_msg->data.data[2];
  anglesIKBL.tetta = angles_msg->data.data[0];
  anglesIKBL.alpha = angles_msg->data.data[1];
  anglesIKBL.gamma = angles_msg->data.data[2];
  stepMotors();
}
...
bool create_entities()
{
  ...
  RCCHECK(rclc_publisher_init_best_effort(
    ...
    "status_msg_Int32MultiArray"));
  status_msg.data.capacity = 10;
  status_msg.data.size = 4;
  status_msg.data.data = (int32_t*) malloc(3 * sizeof(int32_t)); 
