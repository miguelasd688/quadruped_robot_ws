...
class RobotRun(Node):
    ...
    def listener_status_callback(self, msg):
        ...
        self.robot_player.calibration_action = msg.data[5]
        self.tmp = msg.data[6]
    ...
    def publishCalibrationTopic(self):  
        calibration_state = Int8MultiArray()
        calibration_state.data = [0,1,2]
        self.calibration_publisher.publish(calibration_state)
